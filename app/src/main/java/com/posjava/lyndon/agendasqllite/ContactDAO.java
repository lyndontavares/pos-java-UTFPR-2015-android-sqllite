...
public class ContactDAO extends Activity {
	...
	add_save_btn.setOnClickListener(new View.OnClickListener() {
		...
		if (valid_name != null && valid_mob_number != null
		    ...
		    Toast_msg = "Adicionado com sucesso!";
	...
	update_btn.setOnClickListener(new View.OnClickListener() {
		...
		if (valid_name != null && valid_mob_number != null
		    ...
		    dbHandler.Update_Contact(new Contact(USER_ID, valid_name,
			    valid_mob_number, valid_email));
		    dbHandler.close();
		    Toast_msg = "Atualizado com sucesso!";
		    Show_Toast(Toast_msg);
		    Reset_Text();
		} else {
		    Toast_msg = "Campo faltantes.\nPreencha todos os campos.";
		    Show_Toast(Toast_msg);
		}
	...
	update_view_all.setOnClickListener(new View.OnClickListener() {
	    ...
	    public void onClick(View v) {
		// TODO Auto-generated method stub
		Intent view_user = new Intent(ContactDAO.this,
			Principal.class);
	...
	if (edt.getText().toString().length() <= 0) {
	    ...
	    edt.setError("Mínimo: " + MinLen);
	    valid_mob_number = null;

	} else if (edt.getText().toString().length() > MaxLen) {
	    edt.setError("Máximo: " + MaxLen);
	    valid_mob_number = null;
